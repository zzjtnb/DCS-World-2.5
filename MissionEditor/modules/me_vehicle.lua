...
function initModule()
	...
	subCat['Radar'] 				= _('Radar_SUBCAT', 'Radar')
	subCat['Launcher'] 				= _('Launcher_SUBCAT', 'Launcher')
	subCat['Tracker'] 				= _('Tracker_SUBCAT', 'Tracker')
	subCat['Generator'] 			= _('Generator_SUBCAT', 'Generator')
	subCat['SAM SHORAD'] 			= _('SAM SHORAD_SUBCAT', 'SAM SHORAD')
	subCat['Command and Control'] 	= _('Command and Control_SUBCAT', 'Command and Control')
	subCat['MANPAD'] 				= _('MANPAD_SUBCAT', 'MANPAD')
	subCat['MANPAD C2'] 			= _('MANPAD C2_SUBCAT', 'MANPAD C2')
	subCat['Player Drivable'] 		= _('Player Drivable_SUBCAT', 'Player Drivable')
	
	--Armor
	subCat['APCandIFV'] 			= _('APC and IFV_SUBCAT', 'APC and IFV')
	subCat['Tank'] 					= _('Tank_SUBCAT', 'Tank')
	subCat['MBT'] 					= _('MBT_SUBCAT', 'MBT')
	subCat['Scout'] 				= _('Scout_SUBCAT', 'Scout')
	subCat['Assault gun'] 			= _('Assault gun_SUBCAT', 'Assault gun')
	subCat['Armored car'] 			= _('Armored car_SUBCAT', 'Armored car')
	subCat['Tank destroyer'] 		= _('Tank destroyer_SUBCAT', 'Tank destroyer')
	subCat['SP ATGM']				= _('Self-propelled ATGM_SUBCAT', 'Self-propelled ATGM')
	subCat['Player Drivable'] 		= _('Player Drivable_SUBCAT', 'Player Drivable')
	
	--Unarmed
	subCat['Support'] 				= _('Support_SUBCAT', 'Support')
	subCat['Logistics'] 			= _('Logistics_SUBCAT', 'Logistics')
	subCat['Tractor'] 				= _('Tractor_SUBCAT', 'Tractor')
	subCat['Tanker'] 				= _('Tanker_SUBCAT', 'Tanker')
	subCat['Civilian'] 				= _('Civilian_SUBCAT', 'Civilian')
	subCat['UAV'] 					= _('UAV_SUBCAT', 'UAV')
	subCat['Animals'] 				= _('Animals_SUBCAT', 'Animals')
	subCat['C2'] 					= _('Command and control_SUBCAT', 'Command and control')
	subCat['Player Drivable'] 		= _('Player Drivable_SUBCAT', 'Player Drivable')
	...
	subCat['FDDM and JTAC'] 		= _('FDDM and JTAC_SUBCAT', 'FDDM and JTAC')
	subCat['MRL'] 					= _('MRL_SUBCAT', 'MRL')
	subCat['Player Drivable'] 		= _('Player Drivable_SUBCAT', 'Player Drivable')
	...
	subCatByCat = {}
	subCatByCat["Air Defence"] 	= {'AAA', 'SP AAA', 'Radar', 'Launcher', 'Tracker', 'Generator', 'SAM SHORAD',
									'Command and Control', 'MANPAD', 'MANPAD C2', 'Player Drivable'}
									
	subCatByCat["Armor"] 		= {'APCandIFV', 'Tank', 'MBT', 'Scout', 'Assault gun', 'Armored car', 
									'Tank destroyer', 'SP ATGM', 'Player Drivable'}
	subCatByCat["Unarmed"] 		= {'Support', 'Logistics', 'Tractor', 'Tanker', 'Civilian', 'UAV',
									'Animals', 'C2', 'Player Drivable'}
	subCatByCat["MissilesSS"] 	= {'SSM', 'Player Drivable'}
	subCatByCat["Artillery"] 	= {'SPA', 'Mortar', 'FDDM and JTAC', 'MRL', 'Player Drivable'}
	...
	tagsBySubCat['Radar'] 				= {'Radar'}
	tagsBySubCat['Launcher'] 			= {'Launcher'}
	tagsBySubCat['Tracker'] 			= {'Tracker'}
	tagsBySubCat['Generator'] 			= {'Generator'}
	tagsBySubCat['SAM SHORAD'] 			= {'SAM SHORAD'}
	tagsBySubCat['Command and Control']	= {'Command and Control'}
	tagsBySubCat['MANPAD'] 				= {'MANPAD'}
	tagsBySubCat['MANPAD C2'] 			= {'MANPAD C2'}
	
	--Armor
	tagsBySubCat['APCandIFV'] 				= {'APC', 'IFV'}
	tagsBySubCat['Tank'] 				= {'Tank'}
	tagsBySubCat['MBT'] 				= {'MBT'}
	tagsBySubCat['Scout'] 				= {'Scout', 'Recon'}
	tagsBySubCat['Assault gun'] 		= {'AG'}
	tagsBySubCat['Armored car'] 		= {'AC'}
	tagsBySubCat['Tank destroyer'] 		= {'TD'}
	tagsBySubCat['SP ATGM'] 			= {'SP ATGM'}
	
	--Unarmed
	tagsBySubCat['Support'] 			= {'Support'}
	tagsBySubCat['Logistics'] 			= {'Logistics'}
	tagsBySubCat['Tractor'] 			= {'Tractor'}
	tagsBySubCat['Tanker'] 				= {'Tanker'}
	tagsBySubCat['Civilian'] 			= {'Civilian'}
	tagsBySubCat['UAV'] 				= {'UAV'}
	...
	tagsBySubCat['FDDM and JTAC'] 		= {'JTAC', 'FDDM'}
	...
	if cv_list == nil then
		...
		for i,v in base.pairs(me_db_api.db.Countries) do
			...
			--		base.print("--sort--",v.Name,cat,subCatName)
					...
					if v.Name == 'USA' and cat == 'Air Defence' and subCatName == 'All' then
			--			base.U.traverseTable(cv_list[v.Name][cat][subCatName])
			--			base.print("---hhh---")
					end
				end
			end
		...
		for category, subCats in base.pairs(list[a_country]) do
			for subCatName, subCat in base.pairs(subCats) do	
				for kkk, tbl in base.ipairs(subCat) do	
					...
					--	country_vehicle_list[a_country][category]["All"] = country_vehicle_list[a_country][category]["All"] or {}
					--	base.table.insert(country_vehicle_list[a_country][category]["All"], tbl.type)						
...
function fillSubCategory()
	...
	local subCats = subCatByCat[category]
